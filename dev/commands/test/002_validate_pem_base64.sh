echo ""
echo ""
echo "***** 002_validate_pem_base64 *****" 
echo "-----------------------------------------------------------------------"
echo "Installing SecretProviderClass - pem - base64" 
echo "-----------------------------------------------------------------------"
...
kubectl exec -it webapp -- cat /etc/ssl/tls.crt | base64 --decode > ./tls.crt
kubectl exec -it webapp -- cat /etc/ssl/tls.key | base64 --decode > ./tls.key
kubectl exec -it webapp -- cat /etc/ssl/ca.crt | base64 --decode > ./ca.crt
